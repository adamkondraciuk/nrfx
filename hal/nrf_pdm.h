 ...
 */
NRF_STATIC_INLINE void nrf_pdm_task_trigger(nrf_pdm_task_t task);
 ...
 */
NRF_STATIC_INLINE uint32_t nrf_pdm_task_address_get(nrf_pdm_task_t task);
 ...
 */
NRF_STATIC_INLINE bool nrf_pdm_event_check(nrf_pdm_event_t event);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_event_clear(nrf_pdm_event_t event);
 ...
 */
NRF_STATIC_INLINE uint32_t nrf_pdm_event_address_get(nrf_pdm_event_t event);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_int_enable(uint32_t int_mask);
 ...
 */
NRF_STATIC_INLINE bool nrf_pdm_int_enable_check(uint32_t int_mask);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_int_disable(uint32_t int_mask);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_subscribe_set(nrf_pdm_task_t task,
                                             uint8_t        channel);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_subscribe_clear(nrf_pdm_task_t task);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_publish_set(nrf_pdm_event_t event,
                                           uint8_t         channel);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_publish_clear(nrf_pdm_event_t event);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_enable(void);

/** @brief Function for disabling the PDM peripheral. */
NRF_STATIC_INLINE void nrf_pdm_disable(void);
 ...
 */
NRF_STATIC_INLINE bool nrf_pdm_enable_check(void);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_mode_set(nrf_pdm_mode_t pdm_mode, nrf_pdm_edge_t pdm_edge);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_mode_get(nrf_pdm_mode_t * p_pdm_mode, nrf_pdm_edge_t * p_pdm_edge);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_clock_set(nrf_pdm_freq_t pdm_freq);
 ...
 */
NRF_STATIC_INLINE nrf_pdm_freq_t nrf_pdm_clock_get(void);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_psel_connect(uint32_t psel_clk, uint32_t psel_din);

/** @brief Function for disconnecting the PDM pins. */
NRF_STATIC_INLINE void nrf_pdm_psel_disconnect(void);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_gain_set(nrf_pdm_gain_t gain_l, nrf_pdm_gain_t gain_r);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_gain_get(nrf_pdm_gain_t * p_gain_l, nrf_pdm_gain_t * p_gain_r);
 ...
 */
NRF_STATIC_INLINE void nrf_pdm_buffer_set(uint32_t * p_buffer, uint32_t num);
 ...
 */
NRF_STATIC_INLINE uint32_t * nrf_pdm_buffer_get(void);
