...
/** @brief Symbol specifying the maximum number of available requests events. */
#define NRF_PCRM_EVENTS_REQUEST_COUNT \
    NRFX_MAX(NRF_PCRM_EVENTS_REQUEST_RISING_COUNT, NRF_PCRM_EVENTS_REQUEST_FALLING_COUNT)
...
#if NRF_PCRM_EVENTS_REQUEST_RISING_COUNT > 28
...
#if NRF_PCRM_EVENTS_REQUEST_FALLING_COUNT > 28
...
#endif
#if NRF_PCRM_EVENTS_REQUEST_FALLING_COUNT > 30
...
#endif
#if NRF_PCRM_EVENTS_REQUEST_FALLING_COUNT > 31
...
#if NRF_PCRM_EVENTS_LOAD_CHANGE_RAIL_COUNT > 2
...
#if NRF_PCRM_EVENTS_REQUEST_COUNT > 28
