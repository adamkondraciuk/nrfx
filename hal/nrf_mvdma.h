...
typedef enum
{
    NRF_MVDMA_SOURCE_ERROR_OK     = MVDMA_STATUS_SOURCEBUSERROR_BUSERROR_NoError,     ///< No error.
...
typedef enum
{
    NRF_MVDMA_SINK_ERROR_OK           = MVDMA_STATUS_SINKBUSERROR_BUSERROR_NoError,          ///< No error.
