 ...
 */
NRF_STATIC_INLINE void nrf_wdt_behaviour_set(nrf_wdt_behaviour_t behaviour);
 ...
 * @param[in] task Task.
 */
NRF_STATIC_INLINE void nrf_wdt_task_trigger(nrf_wdt_task_t task);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_event_clear(nrf_wdt_event_t event);
 ...
 */
NRF_STATIC_INLINE bool nrf_wdt_event_check(nrf_wdt_event_t event);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_int_enable(uint32_t int_mask);
 ...
 */
NRF_STATIC_INLINE bool nrf_wdt_int_enable_check(uint32_t int_mask);
 ...
 * @param[in] int_mask Interrupt.
 */
NRF_STATIC_INLINE void nrf_wdt_int_disable(uint32_t int_mask);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_subscribe_set(nrf_wdt_task_t task,
                                             uint8_t        channel);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_subscribe_clear(nrf_wdt_task_t task);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_publish_set(nrf_wdt_event_t event,
                                           uint8_t         channel);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_publish_clear(nrf_wdt_event_t event);
 ...
 * @param[in] task Task.
 */
NRF_STATIC_INLINE uint32_t nrf_wdt_task_address_get(nrf_wdt_task_t task);
 ...
 */
NRF_STATIC_INLINE uint32_t nrf_wdt_event_address_get(nrf_wdt_event_t event);
 ...
 */
NRF_STATIC_INLINE bool nrf_wdt_started(void);
 ...
 */
NRF_STATIC_INLINE bool nrf_wdt_request_status(nrf_wdt_rr_register_t rr_register);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_reload_value_set(uint32_t reload_value);
 ...
 * @return Reload value.
 */
NRF_STATIC_INLINE uint32_t nrf_wdt_reload_value_get(void);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_reload_request_enable(nrf_wdt_rr_register_t rr_register);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_reload_request_disable(nrf_wdt_rr_register_t rr_register);
 ...
 */
NRF_STATIC_INLINE bool nrf_wdt_reload_request_is_enabled(nrf_wdt_rr_register_t rr_register);
 ...
 */
NRF_STATIC_INLINE void nrf_wdt_reload_request_set(nrf_wdt_rr_register_t rr_register);
