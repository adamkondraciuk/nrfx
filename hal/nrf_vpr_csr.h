...
typedef enum
{
    ...
    NRF_VPR_CSR_TRAP_CAUSE_INSTR_ACCESS_FAULT    = VPRCSR_MCAUSE_EXECPTIONCODE_INSTACCESSFAULT,    ///< Instruction access fault.
    ...
    NRF_VPR_CSR_TRAP_CAUSE_LOAD_ACCESS_FAULT     = VPRCSR_MCAUSE_EXECPTIONCODE_LOADACCESSFAULT,    ///< Load access fault.
    NRF_VPR_CSR_TRAP_CAUSE_STORE_ADDR_MISALIGNED = VPRCSR_MCAUSE_EXECPTIONCODE_STOREADDRMISALIGN,  ///< Store/AMO address misaligned.
    NRF_VPR_CSR_TRAP_CAUSE_STORE_ACCESS_FAULT    = VPRCSR_MCAUSE_EXECPTIONCODE_STOREACCESSFAULT,   ///< Store/AMO access misaligned.
#if !defined(LILIUMSOC1_XXAA) && !defined(NRF7140_XXAA) && !defined(NRF9230_XXAA)
...
#else
    NRF_VPR_CSR_TRAP_CAUSE_STACKING_UNALIGNED    = VPRCSR_MCAUSE_EXECPTIONCODE_MISALIGNSTACKING,   ///< Misaligned Stacking.
    NRF_VPR_CSR_TRAP_CAUSE_VECTOR_FAULT          = VPRCSR_MCAUSE_EXECPTIONCODE_INTVECTORFAULT,     ///< Interrupt Vector Fault.
    NRF_VPR_CSR_TRAP_CAUSE_STACKING_UNALIGNED_EX = VPRCSR_MCAUSE_EXECPTIONCODE_STACKINGEXCFAULT,   ///< Fault on Exception Stacking.
#endif
