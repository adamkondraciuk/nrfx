...
typedef enum
{
    NRF_VPR_CSR_TRAP_CAUSE_INSTR_ADDR_MISALIGNED = VPRCSR_MCAUSE_EXECPTIONCODE_INSTADDRMISALIGN,   ///< Instruction address misaligned.
    NRF_VPR_CSR_TRAP_CAUSE_INSTR_ACCESS_FALUT    = VPRCSR_MCAUSE_EXECPTIONCODE_INSTACCESSFAULT,    ///< Instruction access fault.
    NRF_VPR_CSR_TRAP_CAUSE_INSTR_ILLEGAL         = VPRCSR_MCAUSE_EXECPTIONCODE_ILLEGALINST,        ///< Illegal instruction.
    NRF_VPR_CSR_TRAP_CAUSE_BREAKPOINT            = VPRCSR_MCAUSE_EXECPTIONCODE_BKPT,               ///< Breakpoint.
    NRF_VPR_CSR_TRAP_CAUSE_LOAD_ADDR_MISALIGNED  = VPRCSR_MCAUSE_EXECPTIONCODE_LOADADDRMISALIGN,   ///< Load address misaligned.
    NRF_VPR_CSR_TRAP_CAUSE_LOAD_ACCESS_FALUT     = VPRCSR_MCAUSE_EXECPTIONCODE_LOADACCESSFAULT,    ///< Load access fault.
    NRF_VPR_CSR_TRAP_CAUSE_STORE_ADDR_MISALIGNED = VPRCSR_MCAUSE_EXECPTIONCODE_STOREADDRMISALIGN,  ///< Store/AMO address misaligned.
    NRF_VPR_CSR_TRAP_CAUSE_STORE_ACCESS_FALUT    = VPRCSR_MCAUSE_EXECPTIONCODE_STOREACCESSFAULT,   ///< Store/AMO access misaligned.
    NRF_VPR_CSR_TRAP_CAUSE_ECALL_U               = VPRCSR_MCAUSE_EXECPTIONCODE_ECALLUMODE,         ///< Environment call U-mode.
    NRF_VPR_CSR_TRAP_CAUSE_ECALL_S               = VPRCSR_MCAUSE_EXECPTIONCODE_ECALLSMODE,         ///< Environment call S-mode.
    NRF_VPR_CSR_TRAP_CAUSE_ECALL_M               = VPRCSR_MCAUSE_EXECPTIONCODE_ECALLMMODE,         ///< Environment call M-mode.
    NRF_VPR_CSR_TRAP_CAUSE_INSTR_PAGE_FAULT      = VPRCSR_MCAUSE_EXECPTIONCODE_INSTPAGEFAULT,      ///< Instruction page fault.
    NRF_VPR_CSR_TRAP_CAUSE_LOAD_PAGE_FAULT       = VPRCSR_MCAUSE_EXECPTIONCODE_LOADPAGEFAULT,      ///< Load page fault.
    NRF_VPR_CSR_TRAP_CAUSE_STORE_PAGE_FAULT      = VPRCSR_MCAUSE_EXECPTIONCODE_STOREPAGEFAULT,     ///< Store/AMO page fault.
    NRF_VPR_CSR_TRAP_CAUSE_STACKING_UNALIGNED    = VPRCSR_MCAUSE_EXECPTIONCODE_UNALIGNSTACKING,    ///< Unaligned stacking.
    NRF_VPR_CSR_TRAP_CAUSE_STACKING_BUS_FAULT    = VPRCSR_MCAUSE_EXECPTIONCODE_BUSFAULTSTACKING,   ///< Bus fault on stacking.
    NRF_VPR_CSR_TRAP_CAUSE_VECTOR_FAULT          = VPRCSR_MCAUSE_EXECPTIONCODE_VECTORFAULT,        ///< Vector fault.
    NRF_VPR_CSR_TRAP_CAUSE_UNSTACKING_UNALIGNED  = VPRCSR_MCAUSE_EXECPTIONCODE_UNALIGNUNSTACKING,  ///< Unaligned unstacking.
    NRF_VPR_CSR_TRAP_CAUSE_UNSTACKING_BUS_FAULT  = VPRCSR_MCAUSE_EXECPTIONCODE_BUSFAULTUNSTACKING, ///< Bus fault on unstacking.
    NRF_VPR_CSR_TRAP_CAUSE_STORE_TIMEOUT_FAULT   = VPRCSR_MCAUSE_EXECPTIONCODE_STORETIMEOUTFAULT,  ///< Store timeout fault.
...
NRF_STATIC_INLINE nrf_vpr_csr_trap_cause_t nrf_vpr_csr_machine_trap_cause_code_get(void)
{
    return csr_read(VPRCSR_MCAUSE) & VPRCSR_MCAUSE_EXECPTIONCODE_Msk;
}
...
NRF_STATIC_INLINE void nrf_vpr_csr_rtperiph_enable_set(bool enable)
{
    ...
    reg &= ~(VPRCSR_NORDIC_VPRNORDICCTRL_ENABLERTPERIPH_Msk | NRF_VPR_CSR_NORDIC_KEY_MASK);
...
{
    uint32_t reg = csr_read(VPRCSR_NORDIC_VPRNORDICCTRL);
    reg &= ~(VPRCSR_NORDIC_VPRNORDICCTRL_FORCEEXTCLK_Msk | NRF_VPR_CSR_NORDIC_KEY_MASK);
...
{
    uint32_t reg = csr_read(VPRCSR_NORDIC_VPRNORDICCTRL);
    reg &= ~(VPRCSR_NORDIC_VPRNORDICCTRL_FORCERAMCLK_Msk | NRF_VPR_CSR_NORDIC_KEY_MASK);
...
NRF_STATIC_INLINE void nrf_vpr_csr_clic_round_robin_set(bool enable)
{
    ...
    reg &= ~(VPRCSR_NORDIC_VPRNORDICFEATURESDISABLE_DISABLECLICROUNDROBIN_Msk |
...
{
    uint32_t reg = csr_read(VPRCSR_NORDIC_VPRNORDICFEATURESDISABLE);
    reg &= ~(VPRCSR_NORDIC_VPRNORDICFEATURESDISABLE_UNRECOVRETURN_Msk |
             NRF_VPR_CSR_NORDIC_KEY_MASK);
...
{
    uint32_t reg = csr_read(VPRCSR_NORDIC_VPRNORDICFEATURESDISABLE);
    reg &= ~(VPRCSR_NORDIC_VPRNORDICFEATURESDISABLE_TIMEOUTCHK_Msk | NRF_VPR_CSR_NORDIC_KEY_MASK);
