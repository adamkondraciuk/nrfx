...
__vector_table
        ...
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     GRCCONF_0_IRQHandler
        DCD     GRCCONF_1_IRQHandler
        DCD     GRCCONF_2_IRQHandler
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
...
EGU130_IRQHandler
        ...
        PUBWEAK  GRCCONF_0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
GRCCONF_0_IRQHandler
        j .

        PUBWEAK  GRCCONF_1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
GRCCONF_1_IRQHandler
        j .

        PUBWEAK  GRCCONF_2_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
