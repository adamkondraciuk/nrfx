...
__vector_table
        ...
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     UMACCLIC_16_IRQHandler
        DCD     UMACCLIC_17_IRQHandler
        DCD     UMACCLIC_18_IRQHandler
        DCD     UMACCLIC_19_IRQHandler
        DCD     UMACCLIC_20_IRQHandler
        DCD     UMACCLIC_21_IRQHandler
        DCD     UMACCLIC_22_IRQHandler
        DCD     UMACCLIC_23_IRQHandler
        DCD     UMACCLIC_24_IRQHandler
        DCD     UMACCLIC_25_IRQHandler
        DCD     UMACCLIC_26_IRQHandler
...
CLICSoftware_Handler
       ...
       ; Dummy interrupt handlers
        ...
        PUBWEAK  UMACCLIC_16_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_16_IRQHandler
        j .

        PUBWEAK  UMACCLIC_17_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_17_IRQHandler
        j .

        PUBWEAK  UMACCLIC_18_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_18_IRQHandler
        j .

        PUBWEAK  UMACCLIC_19_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_19_IRQHandler
        j .

        PUBWEAK  UMACCLIC_20_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_20_IRQHandler
        j .

        PUBWEAK  UMACCLIC_21_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_21_IRQHandler
        j .

        PUBWEAK  UMACCLIC_22_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_22_IRQHandler
        j .

        PUBWEAK  UMACCLIC_23_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_23_IRQHandler
        j .

        PUBWEAK  UMACCLIC_24_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_24_IRQHandler
        j .

        PUBWEAK  UMACCLIC_25_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
UMACCLIC_25_IRQHandler
        j .

        PUBWEAK  UMACCLIC_26_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
