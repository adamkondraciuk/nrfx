...
__vector_table
        ...
        DCD     LMACCLIC_19_IRQHandler
        DCD     LMACCLIC_20_IRQHandler
...
CLICSoftware_Handler
       ...
       ; Dummy interrupt handlers
        ...
        PUBWEAK  LMACCLIC_16_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LMACCLIC_16_IRQHandler
        j .

        PUBWEAK  LMACCLIC_17_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LMACCLIC_17_IRQHandler
        j .

        PUBWEAK  LMACCLIC_18_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LMACCLIC_18_IRQHandler
        j .

        PUBWEAK  LMACCLIC_19_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LMACCLIC_19_IRQHandler
        j .

        PUBWEAK  LMACCLIC_20_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LMACCLIC_20_IRQHandler
        j .

        PUBWEAK  LMACCLIC_21_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LMACCLIC_21_IRQHandler
        j .

        PUBWEAK  LMACCLIC_22_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
