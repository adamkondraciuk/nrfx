...
__vector_table
        ...
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     BELLBOARD_ML_0_IRQHandler
        DCD     BELLBOARD_ML_1_IRQHandler
        DCD     BELLBOARD_ML_2_IRQHandler
        DCD     BELLBOARD_ML_3_IRQHandler
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
...
IPCT_1_IRQHandler
        ...
        PUBWEAK  BELLBOARD_ML_0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
BELLBOARD_ML_0_IRQHandler
        j .

        PUBWEAK  BELLBOARD_ML_1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
BELLBOARD_ML_1_IRQHandler
        j .

        PUBWEAK  BELLBOARD_ML_2_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
BELLBOARD_ML_2_IRQHandler
        j .

        PUBWEAK  BELLBOARD_ML_3_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
BELLBOARD_ML_3_IRQHandler
        j .
