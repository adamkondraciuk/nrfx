        ...
        * operations are not used in your code. */
        ...
        SCB->NSACR |= (3UL << 10ul);
            ...
            Specification to see which ones). */
                ...
                NRF_VPR00->DEBUGIF.DMCONTROL = (VPR_DEBUGIF_DMCONTROL_NDMRESET_Active << VPR_DEBUGIF_DMCONTROL_NDMRESET_Pos) | (VPR_DEBUGIF_DMCONTROL_DMACTIVE_Enabled << VPR_DEBUGIF_DMCONTROL_DMACTIVE_Pos);

                // De-assert a sync reset in FLPR
                NRF_VPR00->DEBUGIF.DMCONTROL = (VPR_DEBUGIF_DMCONTROL_NDMRESET_Inactive << VPR_DEBUGIF_DMCONTROL_NDMRESET_Pos) | (VPR_DEBUGIF_DMCONTROL_DMACTIVE_Disabled << VPR_DEBUGIF_DMCONTROL_DMACTIVE_Pos);
            #endif
        #endif
