...
__vector_table
        ...
        DCD     SPU310_IRQHandler
        DCD     SPU410_IRQHandler
        ...
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     SPU111_IRQHandler
        DCD     MPC111_IRQHandler
...
GRTC_2_IRQHandler
        ...
        PUBWEAK  SPU310_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SPU310_IRQHandler
        B .

        PUBWEAK  SPU410_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SPU410_IRQHandler
        B .
...
GPU_IRQHandler
        ...
        PUBWEAK  MPC200_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
MPC200_IRQHandler
        B .

        PUBWEAK  SPU200_SPU210_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
...
TBM_IRQHandler
        ...
        PUBWEAK  SPU110_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SPU110_IRQHandler
        B .

        PUBWEAK  MPC110_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
MPC110_IRQHandler
        B .
...
USBHS_IRQHandler
        ...
        PUBWEAK  SPU111_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SPU111_IRQHandler
        B .

        PUBWEAK  MPC111_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
MPC111_IRQHandler
        B .
...
SPIM123_IRQHandler
        ...
        PUBWEAK  SPU130_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SPU130_IRQHandler
        B .

        PUBWEAK  MPC130_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
MPC130_IRQHandler
        B .
