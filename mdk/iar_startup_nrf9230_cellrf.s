...
TXDFE_IRQHandler
        ...
        PUBWEAK  EGUTX_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
EGUTX_IRQHandler
        B .

        PUBWEAK  RXDFE_0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RXDFE_0_IRQHandler
        B .

        PUBWEAK  RXDFE_1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RXDFE_1_IRQHandler
        B .
...
EGURX_IRQHandler
        ...
        PUBWEAK  RXDFEGNSS_0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RXDFEGNSS_0_IRQHandler
        B .

        PUBWEAK  RXDFEGNSS_1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RXDFEGNSS_1_IRQHandler
        B .

        PUBWEAK  DSA2TX_0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
DSA2TX_0_IRQHandler
        B .

        PUBWEAK  DSA2TX_1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
DSA2TX_1_IRQHandler
        B .

        PUBWEAK  DSA2RX_0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
DSA2RX_0_IRQHandler
        B .

        PUBWEAK  DSA2RX_1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
DSA2RX_1_IRQHandler
        B .
