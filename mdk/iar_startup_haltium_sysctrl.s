...
__vector_table
        ...
        DCD     RAMC100_IRQHandler
        DCD     RAMC101_IRQHandler
        DCD     AXI100_IRQHandler
        DCD     USBHS_IRQHandler
        DCD     0                         ; Reserved
        DCD     SHA3_IRQHandler
        DCD     0                         ; Reserved
        DCD     RAMC102_IRQHandler
        DCD     RAMC103_IRQHandler
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        ...
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     RAMC120_IRQHandler
        DCD     RAMC121_IRQHandler
        DCD     OTPC_IRQHandler
        DCD     ROMC_IRQHandler
        DCD     0                         ; Reserved
        DCD     VPR_IRQHandler
        ...
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     RAMC130_IRQHandler
        DCD     RAMC131_IRQHandler
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
        DCD     0                         ; Reserved
...
L2CACHE_IRQHandler
        ...
        PUBWEAK  RAMC100_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RAMC100_IRQHandler
        j .

        PUBWEAK  RAMC101_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RAMC101_IRQHandler
        j .

        PUBWEAK  AXI100_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
AXI100_IRQHandler
        j .
...
SHA3_IRQHandler
        ...
        PUBWEAK  RAMC102_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RAMC102_IRQHandler
        j .

        PUBWEAK  RAMC103_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RAMC103_IRQHandler
        j .
...
MVDMA_IRQHandler
        ...
        PUBWEAK  RAMC120_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RAMC120_IRQHandler
        j .

        PUBWEAK  RAMC121_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RAMC121_IRQHandler
        j .
...
HSFLL_IRQHandler
        ...
        PUBWEAK  LRCCONF120_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LRCCONF120_IRQHandler
        j .
...
TWIM120_IRQHandler
        ...
        PUBWEAK  RAMC130_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RAMC130_IRQHandler
        j .

        PUBWEAK  RAMC131_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
RAMC131_IRQHandler
        j .
...
EGU130_IRQHandler
        ...
        PUBWEAK  LRCCONF130_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LRCCONF130_IRQHandler
        j .
