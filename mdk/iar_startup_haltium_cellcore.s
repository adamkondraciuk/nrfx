...
RTC_IRQHandler
        ...
        PUBWEAK  SPU2_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SPU2_IRQHandler
        B .

        PUBWEAK  LRCCONF2_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LRCCONF2_IRQHandler
        B .
...
LFCLKCALIBMEAS_IRQHandler
        ...
        PUBWEAK  SPU3_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SPU3_IRQHandler
        B .

        PUBWEAK  LRCCONF3_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LRCCONF3_IRQHandler
        B .
...
IPCT3_IRQHandler
        ...
        PUBWEAK  SYSTEMTIMER0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SYSTEMTIMER0_IRQHandler
        B .

        PUBWEAK  SYSTEMTIMER1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SYSTEMTIMER1_IRQHandler
        B .

        PUBWEAK  LTETIMER0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LTETIMER0_IRQHandler
        B .

        PUBWEAK  LTETIMER1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LTETIMER1_IRQHandler
        B .

        PUBWEAK  GNSSTIMER0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
GNSSTIMER0_IRQHandler
        B .

        PUBWEAK  GNSSTIMER1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
