...
Default_Handler PROC
                ...
                EXPORT   UARTE_IRQHandler [WEAK]
                EXPORT   TIMER1_IRQHandler [WEAK]
                EXPORT   TIMER11_IRQHandler [WEAK]
                EXPORT   RTC_IRQHandler [WEAK]
                EXPORT   LWDT_IRQHandler [WEAK]
                EXPORT   SWDT_IRQHandler [WEAK]
                EXPORT   RNG_IRQHandler [WEAK]
                EXPORT   SIMIF_IRQHandler [WEAK]
                EXPORT   M2M0_IRQHandler [WEAK]
                EXPORT   M2M1_IRQHandler [WEAK]
                EXPORT   GPIOTE0_IRQHandler [WEAK]
                EXPORT   GPIOTE1_IRQHandler [WEAK]
                EXPORT   GPIOTE2_IRQHandler [WEAK]
                EXPORT   TEMP_IRQHandler [WEAK]
                EXPORT   LFCLKCALIBMEAS_IRQHandler [WEAK]
                EXPORT   TWIM_IRQHandler [WEAK]
                EXPORT   AESL2_IRQHandler [WEAK]
                EXPORT   SNOW_IRQHandler [WEAK]
                EXPORT   ZUC_IRQHandler [WEAK]
                EXPORT   SHA_IRQHandler [WEAK]
                EXPORT   TLSAES_IRQHandler [WEAK]
                EXPORT   DESCIPHER_IRQHandler [WEAK]
                EXPORT   IPC_IRQHandler [WEAK]
                EXPORT   IPC1_IRQHandler [WEAK]
                EXPORT   IPC2_IRQHandler [WEAK]
