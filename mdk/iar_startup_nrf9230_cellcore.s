...
MCPLL_IRQHandler
        ...
        PUBWEAK  SYSTEMTIMER_0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SYSTEMTIMER_0_IRQHandler
        B .

        PUBWEAK  SYSTEMTIMER_1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SYSTEMTIMER_1_IRQHandler
        B .

        PUBWEAK  LTETIMER_0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LTETIMER_0_IRQHandler
        B .

        PUBWEAK  LTETIMER_1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
LTETIMER_1_IRQHandler
        B .

        PUBWEAK  GNSSTIMER_0_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
GNSSTIMER_0_IRQHandler
        B .

        PUBWEAK  GNSSTIMER_1_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
...
IPCT_2_IRQHandler
        ...
        PUBWEAK  IPCT_3_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
IPCT_3_IRQHandler
        B .

        PUBWEAK  IPCT_4_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
IPCT_4_IRQHandler
        B .

        PUBWEAK  IPCT_5_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
IPCT_5_IRQHandler
        B .
...
ISIM_MHU_1_IRQHandler
        ...
        PUBWEAK  ISIM_SPU_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
ISIM_SPU_IRQHandler
        B .

        PUBWEAK  ISIM_MPC_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
ISIM_MPC_IRQHandler
        B .

        PUBWEAK  ISIM_CICTRL_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
