...
/**************************************************************************************************/
    ...
    #if defined(RTC130_CC_NUM_MAX) && !defined(RTC130_CC_NUM)
    ...
    #endif
    #if defined(TIMER021_MAX_SIZE_MAX) && !defined(TIMER021_MAX_SIZE)
        #define TIMER021_MAX_SIZE (TIMER021_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER022_MAX_SIZE_MAX) && !defined(TIMER022_MAX_SIZE)
        #define TIMER022_MAX_SIZE (TIMER022_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER120_MAX_SIZE_MAX) && !defined(TIMER120_MAX_SIZE)
        #define TIMER120_MAX_SIZE (TIMER120_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER121_MAX_SIZE_MAX) && !defined(TIMER121_MAX_SIZE)
        #define TIMER121_MAX_SIZE (TIMER121_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER130_MAX_SIZE_MAX) && !defined(TIMER130_MAX_SIZE)
        #define TIMER130_MAX_SIZE (TIMER130_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER131_MAX_SIZE_MAX) && !defined(TIMER131_MAX_SIZE)
        #define TIMER131_MAX_SIZE (TIMER131_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER132_MAX_SIZE_MAX) && !defined(TIMER132_MAX_SIZE)
        #define TIMER132_MAX_SIZE (TIMER132_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER133_MAX_SIZE_MAX) && !defined(TIMER133_MAX_SIZE)
        #define TIMER133_MAX_SIZE (TIMER133_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER134_MAX_SIZE_MAX) && !defined(TIMER134_MAX_SIZE)
        #define TIMER134_MAX_SIZE (TIMER134_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER135_MAX_SIZE_MAX) && !defined(TIMER135_MAX_SIZE)
        #define TIMER135_MAX_SIZE (TIMER135_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER136_MAX_SIZE_MAX) && !defined(TIMER136_MAX_SIZE)
        #define TIMER136_MAX_SIZE (TIMER136_MAX_SIZE_MAX + 1UL)
    #endif
    #if defined(TIMER137_MAX_SIZE_MAX) && !defined(TIMER137_MAX_SIZE)
        #define TIMER137_MAX_SIZE (TIMER137_MAX_SIZE_MAX + 1UL)
    #endif

    #if defined(TIMER020_CC_NUM_MAX) && !defined(TIMER020_CC_NUM)
        #define TIMER020_CC_NUM (TIMER020_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER021_CC_NUM_MAX) && !defined(TIMER021_CC_NUM)
        #define TIMER021_CC_NUM (TIMER021_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER022_CC_NUM_MAX) && !defined(TIMER022_CC_NUM)
        #define TIMER022_CC_NUM (TIMER022_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER120_CC_NUM_MAX) && !defined(TIMER120_CC_NUM)
        #define TIMER120_CC_NUM (TIMER120_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER121_CC_NUM_MAX) && !defined(TIMER121_CC_NUM)
        #define TIMER121_CC_NUM (TIMER121_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER130_CC_NUM_MAX) && !defined(TIMER130_CC_NUM)
        #define TIMER130_CC_NUM (TIMER130_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER131_CC_NUM_MAX) && !defined(TIMER131_CC_NUM)
        #define TIMER131_CC_NUM (TIMER131_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER132_CC_NUM_MAX) && !defined(TIMER132_CC_NUM)
        #define TIMER132_CC_NUM (TIMER132_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER133_CC_NUM_MAX) && !defined(TIMER133_CC_NUM)
        #define TIMER133_CC_NUM (TIMER133_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER134_CC_NUM_MAX) && !defined(TIMER134_CC_NUM)
        #define TIMER134_CC_NUM (TIMER134_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER135_CC_NUM_MAX) && !defined(TIMER135_CC_NUM)
        #define TIMER135_CC_NUM (TIMER135_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER136_CC_NUM_MAX) && !defined(TIMER136_CC_NUM)
        #define TIMER136_CC_NUM (TIMER136_CC_NUM_MAX + 1UL)
    #endif
    #if defined(TIMER137_CC_NUM_MAX) && !defined(TIMER137_CC_NUM)
...
/**************************************************************************************************/
    ...
    /* HM-21366 Peripheral capabilities described as _MIN and _MAX instead of single symbol */
    #define SPIM122_EASYDMA_MAXCNT_SIZE (SPIM122_EASYDMA_MAXCNT_SIZE_MAX + 1UL)
    #define SPIM123_EASYDMA_MAXCNT_SIZE (SPIM123_EASYDMA_MAXCNT_SIZE_MAX + 1UL)
    ...
    #define SPIS_SHORTS_DMA_RX_MATCH2_DMA_RX_ENABLEMATCH3_Min (0x0UL)
    #define SPIS_SHORTS_DMA_RX_MATCH2_DMA_RX_ENABLEMATCH3_Max (0x1UL)
    ...
    #define SPIS_SHORTS_DMA_RX_MATCH3_DMA_RX_ENABLEMATCH0_Min (0x0UL)
    #define SPIS_SHORTS_DMA_RX_MATCH3_DMA_RX_ENABLEMATCH0_Max (0x1UL)
