                                ...
                                uint8_t         rx_buffer_length)
{
    ...
    NRFX_LOG_INFO("Transfer tx_len:%d, rx_len:%d.\r\n", tx_buffer_length, rx_buffer_length);
    NRFX_LOG_DEBUG("Tx data:\r\n");
    NRFX_LOG_HEXDUMP_DEBUG((uint8_t *)p_tx_buffer, tx_buffer_length * sizeof(p_tx_buffer));
...
static void finish_transfer(spi_control_block_t * p_cb)
{
    ...
    NRFX_LOG_HEXDUMP_DEBUG((uint8_t *)p_cb->evt.data.done.p_rx_buffer,
...
static void irq_handler_spim(NRF_SPIM_Type * p_spim, spi_control_block_t * p_cb)
{
    ...
    if (nrf_spim_event_check(p_spim, NRF_SPIM_EVENT_END))
    {
        ...
        NRFX_LOG_DEBUG("SPIM: Event: NRF_SPIM_EVENT_END.\r\n");
