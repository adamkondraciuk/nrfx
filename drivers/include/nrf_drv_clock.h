 ...
 *
 * @retval     NRFX_SUCCESS                        If the procedure was successful.
 * @retval     NRFX_ERROR_FORBIDDEN                If a SoftDevice is present or the selected LFCLK source is not an RC oscillator.
 * @retval     NRFX_ERROR_INVALID_STATE            If the low-frequency clock is off.
