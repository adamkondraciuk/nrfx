...
/**
 * Symbols for configuration of power failure comparator.
 *
 * If power failure comparator configuration is contained in REGULATORS peripheral,
 * then symbol translation is needed to match the type in @ref nrfx_power_pofwarn_config_t.
 */
#define nrf_power_pof_thr_t     nrf_regulators_pof_thr_t
#define nrf_power_pof_thrvddh_t nrf_regulators_pof_thrvddh_t
