pipeline {
    ...
    parameters {
        string(name: 'nrfx_build_branch', defaultValue: "nrfx2.7-dev", description: 'Branch for nrfx_build repository')
        string(name: 'nrfx_verification_branch', defaultValue: "nrfx2.7-dev", description: 'Branch for nrfx_verification repository')
