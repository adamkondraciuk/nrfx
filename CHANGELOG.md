...
## [3.3.0] - 2023-12-21
### Added
- Added support for nRF54H20 EngA and nRF54L15 EngA.
...
- Changed how the buffers are provided to the I2S driver. Now buffer size needs to be passed alongside pointers to the next buffers.
...
- Fixed missing CTRLAP reset reason for nRF91 in the POWER HAL.
